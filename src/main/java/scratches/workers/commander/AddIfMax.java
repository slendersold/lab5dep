...
/**
 * Класс, добавляющий элементы только если их значение id максимально.
 * Без интерактива
 *
 * @author slendersold
 * @version 1.1.1
 */
public class AddIfMax implements scratches.workers.commander.Two {
    JSONworker JJ = new JSONworker();
    Gson gson = new Gson();

    /**
     * Добавляет максимальных
     *
